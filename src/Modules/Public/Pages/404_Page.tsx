const Page404 = () => {
	return (
		<div className="w-full h-screen bg-slate-200 pt-20 items-center flex flex-col">
			...
			<img src="/img/undraw_page_not_found_re_e9o6.svg" alt="image" className="m-auto w-72 h-auto" />
			<p className="mx-auto py-12 text-lg font-dayone text-slate-700">Page Not Found! Return to home Page</p>
			<a
				href="/"
